...
void bench_mark(float disorder, t_counter *counter, char *flag)
{
	...
	write (1, "\n", 1);
	ft_printf("[bench] total_ops: %d\n", counter->pa + counter->pb + counter->sa + counter->sb + counter->ss  + counter->ra + counter->rb + counter->rr +
	counter->rra + counter->rrb + counter->rrr);
	ft_printf("[bench] pa: %d pb: %d sa: %d sb: %d ss: %d ra: %d\n", (int)counter->pa, 
        (int)counter->pb, (int)counter->sa, (int)counter->sb, (int)counter->ss, (int)counter->ra);
	
    ft_printf("[bench] rb: %d rr: %d rra: %d rrb: %d rrr: %d\n", (int)counter->rb, (int)counter->rr, 
        (int)counter->rra, (int)counter->rrb, (int)counter->rrr);
}
